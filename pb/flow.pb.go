...
type FlowMessage struct {
	...
	Vnid uint32 `protobuf:"varint,223,opt,name=vnid,proto3" json:"vnid,omitempty"`
	// Inner Source/destination addresses
	InSrcAddr []byte `protobuf:"bytes,206,opt,name=in_src_addr,json=inSrcAddr,proto3" json:"in_src_addr,omitempty"`
	InDstAddr []byte `protobuf:"bytes,207,opt,name=in_dst_addr,json=inDstAddr,proto3" json:"in_dst_addr,omitempty"`
	// Ports for inner UDP and TCP
	InSrcPort uint32 `protobuf:"varint,221,opt,name=in_src_port,json=inSrcPort,proto3" json:"in_src_port,omitempty"`
	InDstPort uint32 `protobuf:"varint,222,opt,name=in_dst_port,json=inDstPort,proto3" json:"in_dst_port,omitempty"`
	// Layer 4 protocol for inner header
	InProto uint32 `protobuf:"varint,220,opt,name=in_proto,json=inProto,proto3" json:"in_proto,omitempty"`
...
func (x *FlowMessage) GetVnid() uint32 {
	if x != nil {
		return x.Vnid
	}
	return 0
...
func (x *FlowMessage) GetInSrcAddr() []byte {
	if x != nil {
		return x.InSrcAddr
	}
	return nil
...
func (x *FlowMessage) GetInDstAddr() []byte {
	if x != nil {
		return x.InDstAddr
	}
	return nil
...
func (x *FlowMessage) GetInSrcPort() uint32 {
	if x != nil {
		return x.InSrcPort
	}
	return 0
...
func (x *FlowMessage) GetInDstPort() uint32 {
	if x != nil {
		return x.InDstPort
	}
	return 0
...
func (x *FlowMessage) GetInProto() uint32 {
	if x != nil {
		return x.InProto
	}
	return 0
...
var file_pb_flow_proto_rawDesc = []byte{
	...
	0x06, 0x66, 0x6c, 0x6f, 0x77, 0x70, 0x62, 0x22, 0xa6, 0x0d, 0x0a, 0x0b, 0x46, 0x6c, 0x6f, 0x77,
	...
	,
	...
	0x6f, 0x63, 0x73, 0x79, 0x73, 0x6d, 0x61, 0x72, 0x73, 0x2f, 0x67, 0x6f, 0x66, 0x6c, 0x6f, 0x77,
